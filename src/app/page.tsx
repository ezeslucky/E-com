...
<div className=" relative mx-auto  text-center lg:text-left flex flex-col items-center lg:items-start">
  ...
  <h1 className=" relative w-fit tracking-tight text-balance mt-16 font-bold  !leading-tight text-gray-900 text-5xl md:text-6xl lg:text-7xl"> Your  Image on a  <span className="  px-2 text-green-600">Custom</span> Phone Case</h1>
...
CaseCobra allows you to protect your memories, not just your phone case.
  ...
  <ul className=" mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
    <div className=" space-y-2">
      ...
      <li className=" flex  gap-1.5 items-center text-left ">
        <Check className=" h-5 w-5 shrink-0 text-green-600 " />
        4 Year print guarantee
      </li>
      <li className=" flex  gap-1.5 items-center text-left ">
        <Check className=" h-5 w-5 shrink-0 text-green-600 " />
        Modern All phone supported
      </li>
    </div>
  </ul>
  ...
  <div className=" mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5 ">
    ...
    <div className=" flex flex-col  justify-center items-center sm:items-center ">
      <div className="  flex gap-0.5">
        <Star className=" h-4 w-4 text-[#f1c40f] fill-[#f1c40f]" />
        <Star className=" h-4 w-4 text-[#f1c40f] fill-[#f1c40f]" />
        <Star className=" h-4 w-4 text-[#f1c40f] fill-[#f1c40f]" />
        <Star className=" h-4 w-4 text-[#f1c40f] fill-[#f1c40f]" />
        <Star className=" h-4 w-4 text-[#f1c40f] fill-[#f1c40f]" />
      ...
      <p className=""> <span className=" font-semibold">1,500</span> Happy customers</p>
    </div>
  </div>
</div>
...
<div className=" col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit ">
  <div className=" relative md:max-w-xl">
    <img src="/your-image.png" alt="" className=" absolute w-40 lg:w-52 left-56 -top-20 select-none sm:block lg:hidden xl:block" />
